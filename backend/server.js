...
const starterMenu = [
  ...
  ['Gulab Jamun','Desserts','Soft milk dumplings in rose-cardamom syrup',129,true,'https://commons.wikimedia.org/wiki/Special:FilePath/Gulab%20jamun.jpg?width=900'],
...
const OrderSchema = new mongoose.Schema({ orderId: String, customerName: String, mobile: String, email: String, tableNumber: String, orderType: String, items: Array, subtotal: Number, tax: Number, serviceCharge: Number, total: Number, specialInstructions: String, status: String }, { timestamps: true });
